...
<div class="limiter">
		...
		<div class="container-table100">
						...
						<thead>
							<tr class="table100-head">
								<th class="column1">Oid</th>
                                                                ...
                                                                <th class="column2">space</th>
								<th class="column2">Astatus</th>
								<th class="column5">CStatus</th>
			...
			String cstatus="no",name=null,space=null,status=null;
                                int id=0;
ResultSet rs=null;
...
try
{
	 con = DBConnectionn.getConnection();
        String qry="select id,name,status,space from oreg where cstatus='"+cstatus+"'";
...
%>
						<tbody>
								<tr>
									...
									<td class="column2"><%=space%></td>
									<td class="column2"><%=status%></td>
									
                                                                        <td class="column5"><a href="cup.jsp?id=<%=id%>&&name=<%=name%>">Accept</a></td>

...
try
{
	 con = DBConnectionn.getConnection();
        String qry="select fuid,oname,fname from upload where oid='"+sessionid+"'";
...
%>
						<tbody>
								<tr>
									<td class="column1"><%=fuid%></td>
                                                                        <td class="column2"><%=name%></td>
									<td class="column3"><%=email%></td>
									
									
                                                                        <td class="column5"><a href="ofileview.jsp?fuid=<%=fuid%>&&email=<%=email%>">view</a></td>
